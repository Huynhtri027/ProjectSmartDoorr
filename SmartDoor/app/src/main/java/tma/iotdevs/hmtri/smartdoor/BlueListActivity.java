...
//Cpde emds
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        {
            progress = ProgressDialog.show(BlueListActivity.this, "Connecting...", "Please wait!!!");  //show a progress dialogue
        }
        ...
        protected void onPostExecute(Void result) //after the doInBackground, it checks if everything went fine
        {
            ...
            if (!ConnectSuccess)
            {
                ...
                Intent iagain = new Intent(BlueListActivity.this,ConnectActivity.class);
            ...
            else
            {
                ...
                Intent i = new Intent(BlueListActivity.this,StatusGetActivity.class);
                startActivity(i);
            }
            progress.dismiss();
        }
